...
import type { BitcoinAddress as _BitcoinAddress, Order as _Order, OrderId as _OrderId, OrderStatus as _OrderStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async bulkUpdateOrderStatus(arg0: Array<OrderId>, arg1: OrderStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.bulkUpdateOrderStatus(arg0, to_candid_OrderStatus_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async claimSiteOwner(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.claimSiteOwner();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createContactMessage(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createContactMessage(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: OrderId, arg1: string, arg2: BitcoinAddress, arg3: string, arg4: bigint, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getOrdersByDenomination(): Promise<Array<[bigint, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrdersByDenomination();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSiteOwner(): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSiteOwner();
    ...
    async getUnreadContactMessageCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getUnreadContactMessageCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateOrderStatus(arg0: OrderId, arg1: OrderStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateOrderStatus(arg0, to_candid_OrderStatus_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: _OrderId;
    status: _OrderStatus;
    btcPaymentAddress: _BitcoinAddress;
    denomination: bigint;
    buyerContact: string;
    amountInBitcoin: string;
    usdtAmount: bigint;
    ...
    return {
        ...
        btcPaymentAddress: value.btcPaymentAddress,
        denomination: value.denomination,
        buyerContact: value.buyerContact,
        amountInBitcoin: value.amountInBitcoin,
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "cancelled" in value ? OrderStatus.cancelled : "paid" in value ? OrderStatus.paid : "pendingPayment" in value ? OrderStatus.pendingPayment : "delivered" in value ? OrderStatus.delivered : value;
}
